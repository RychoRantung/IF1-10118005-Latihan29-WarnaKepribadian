 ...
 */
package if1.pkg10118005.latihan29.warnakepribadian;
 ...
 * KELAS : IF1
 * NIM : 10118005
 * Deskripsi Program :Program berisi program yang melihat kepribadian seseorang berdasarkan warna favoritnya
 */
public class IF110118005Latihan29WarnaKepribadian {
	...
	public static void main(String[] args) {
		...
		String nama = sc.next().toUpperCase();
		...
		System.out.println(  favorit + Reset);
		if (pilih == 5)
